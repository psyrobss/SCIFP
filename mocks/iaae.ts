...
export const IAAE_INVENTORY: InventoryForm = {
  ...
  scoring: {
    type: 'sum',
    description: 'Cada item é pontuado de 0 a 4, invertendo os marcados com (R). O escore total varia de 0 a 160. Escores baixos indicam alta alexitimia/baixa consciência.',
    ranges: [
      { min: 0, max: 53, label: 'Baixa Consciência (Alexitimia Alta)', description: 'Dificuldade acentuada em perceber, nomear e integrar emoções; tendência à racionalização ou somatização.' },
      { min: 54, max: 106, label: 'Consciência Moderada', description: 'Reconhecimento parcial das emoções; flutuações entre insight e bloqueio afetivo.' },
      { min: 107, max: 160, label: 'Consciência Elevada', description: 'Alta consciência emocional; boa capacidade de nomeação, integração e autorregulação.' },
    ],
  }
};
