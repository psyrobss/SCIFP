  ...
  domains: [
    {
      ...
      questions: [
        ...
        { id: 29005, text: 'Quando alguém me elogia, consigo aceitar e acreditar.', isReversed: true }, // Reversão removida no texto original, mas a lógica pede direto se é "aceitar". Ajustando: A frase original era "Acho difícil aceitar". Vou ajustar a frase para ser positiva ou manter a flag. Vou manter a frase original do mock anterior mas ajustada para clareza
